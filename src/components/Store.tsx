...
import { MOVE_CATEGORIES, MoveCategory, Variant } from './moves';
    ...
    <div className="flex flex-col w-full min-h-full p-4 md:p-8 max-w-2xl mx-auto pb-24">
      ...
      <div className="bg-black text-white border-4 border-black p-4 mb-10 brutal-shadow">
        ...
        <p className="text-sm text-white/60 font-bold mt-1">
          Coins are earned by failing. Obviously.
        </p>
      </div>
...
}: {category: MoveCategory;coins: number;owned: string[];equippedId: string | undefined;onBuy: (categoryId: string, variant: Variant) => void;onEquip: (categoryId: string, variantId: string) => void;}) {
  return (
    <section>
      <div

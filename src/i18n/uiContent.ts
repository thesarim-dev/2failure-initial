...
const en: UiContent = {
  ...
  workout: {
    ...
    statusPositioning: 'get in position',
    statusCountdown: 'starting...',
    statusError: 'camera off',
    statusPaused: 'camera paused',
    countdownStart: 'START',
    positionGuidance: {
      no_pose: 'Step into frame so your full body is visible',
      too_dark: 'Too dark — add light or move to a brighter spot',
      too_bright: 'Too bright — reduce backlight or move away from the window',
      blurry: 'Camera is blurry — wipe the lens and hold the phone steady',
      arms_not_visible: 'Show your arms and shoulders — prop the phone to your side',
      legs_not_visible: 'Show your legs from hips to feet — prop the phone to your side',
      straighten_arms: 'Straighten your arms — start at the top of the pushup',
      stand_up: 'Stand tall with legs straight — that is your starting position',
...
const he: UiContent = {
  ...
  workout: {
    ...
    statusPositioning: 'היכנס לעמדת התחלה',
    statusCountdown: 'מתחיל...',
    statusError: 'מצלמה כבויה',
    statusPaused: 'מצלמה מושהית',
    countdownStart: 'התחל',
    positionGuidance: {
      no_pose: 'היכנס לפריים כך שכל הגוף נראה',
      too_dark: 'חשוך מדי — הוסף תאורה או עבור למקום מואר יותר',
      too_bright: 'בהיר מדי — הפחת תאורה אחורית או התרחק מהחלון',
      blurry: 'המצלמה מטושטשת — נקה את העדשה והחזק את הטלפון יציב',
      arms_not_visible: 'הצג זרועות וכתפיים — הנח את הטלפון מהצד',
      legs_not_visible: 'הצג רגליים מירכיים ועד כפות הרגליים — הנח את הטלפון מהצד',
      straighten_arms: 'יישר את הזרועות — התחל בראש השכיבה סמיכה',
      stand_up: 'עמוד זקוף עם רגליים ישרות — זו עמדת ההתחלה',
      hold_still: 'החזק עמדה'
    },
...
const ar: UiContent = {
  ...
  workout: {
    ...
    statusPositioning: 'خذ وضعية البداية',
    statusCountdown: 'جارٍ البدء...',
    statusError: 'الكاميرا مغلقة',
    statusPaused: 'الكاميرا متوقفة',
    countdownStart: 'ابدأ',
    positionGuidance: {
      no_pose: 'ادخل الإطار بحيث يظهر جسمك بالكامل',
      too_dark: 'الإضاءة خافتة — أضف ضوءاً أو انتقل لمكان أفضل',
      too_bright: 'الإضاءة قوية — قلّل الضوء الخلفي أو ابتعد عن النافذة',
      blurry: 'الكاميرا ضبابية — امسح العدسة وأمسك الهاتف بثبات',
      arms_not_visible: 'أظهر ذراعيك وكتفيك — ضع الهاتف من الجانب',
      legs_not_visible: 'أظهر ساقيك من الورك حتى القدم — ضع الهاتف من الجانب',
      straighten_arms: 'افرد ذراعيك — ابدأ من أعلى تمرين الضغط',
      stand_up: 'قف منتصباً وساقاك مفرودتان — هذه وضعية البداية',
      hold_still: 'اثبت في مكانك'
    },
